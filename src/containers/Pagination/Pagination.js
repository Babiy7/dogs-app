...
const Portfolios = ({ pets }) => pets.map((pet, i) => <Portfolio key={i} image={pet.img} name={pet.name} />);
      ...
      <section className={classes.Pagination}>
         <div className={classes.Container}>
            <div className={classes.TextContainer}>
               <h4 className={classes.Title}>Our friends who are looking for a house</h4>
            </div>
            ...
            <div className={classes.Buttons}>
               <PaginationButtons amountOf={indexOfButtons} paginate={paginate} currentPage={currentPage} />
            </div>
         </div>
      </section>
   );
